...
long distance_lidar = -1;                         // Distance measured for lidar
long distance_ultra = -1;                         // Distance measured for ultrasonic
...
else
{
  ...
  distance_lidar = lidarGetRange();                             //return lidar distance
  distance_ultra = (duration / 2) / 29.1;

  //------------------------------------------------------------ Ultra Sonic
  //Target Range
  //if (distance_ultra >= 5 && distance_ultra < 10)
  {
    //Message sent from Uno to micr

    // const char text[] = "\tUltrasonic Flag";
    // radio.write(&text, sizeof(text));


    // int ultra_Nano = distance_ultra;
    // radio.write(&ultra_Nano, sizeof(ultra_Nano));
  }
  // if(distance_lidar >= 5 && distance_lidar < 10)
  {

    //  int lidar_Nano = distance_lidar;
    //  radio.write(&lidar_Nano, sizeof(lidar_Nano));


    //Message sent from Uno to micro
    // const char text[] = "\t\t LIDAR --- Flag";
    // radio.write(&text, sizeof(text));
  }
